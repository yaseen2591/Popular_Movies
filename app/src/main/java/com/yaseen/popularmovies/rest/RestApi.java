...
public class RestApi {
    ...
    public static final String EXTRA_URL="com.yaseen.popularmovies.rest.EXTRA_URL";
    ...
    public static final String ACTION_FETCH_MOVIES = "com.yaseen.popularmovies.rest.FECTH_MOVIES";
    public static final String ACTION_FETCH_TRAILORS="com.yaseen.popularmovies.res.FETCH_TRAILORS";
    public static final String ACTION_FETCH_REVIEWS="com.yaseen.popularmovies.rest.FETCH_REVIEWS";
